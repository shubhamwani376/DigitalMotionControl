...
void wednesday_stuff_step(void)
{
   ...
   */
  rtb_TSamp = wednesday_stuff_P.A_d[0] * wednesday_stuff_DW.UnitDelay_DSTATE[0]
    + wednesday_stuff_DW.UnitDelay_DSTATE[1] * wednesday_stuff_P.A_d[2];
  rtb_SystemMatrix_g = wednesday_stuff_DW.UnitDelay_DSTATE[0] *
  ...
  wednesday_stuff_DW.UnitDelay_DSTATE[0] = (wednesday_stuff_P.B_d[0] *
    wednesday_stuff_B.Sum3 + wednesday_stuff_DW.UnitDelay_DSTATE[0]) + rtb_TSamp;
   ...
   */
  rtb_TSamp = wednesday_stuff_B.Gain * wednesday_stuff_P.TSamp_WtEt;
   ...
   *  Store in Global RAM
   */
  wednesday_stuff_B.Diff = rtb_TSamp - wednesday_stuff_DW.UD_DSTATE;
   ...
   *  Store in Global RAM
   */
  wednesday_stuff_DW.UD_DSTATE = rtb_TSamp;
...
void wednesday_stuff_initialize(void)
{
  ...
  /* External mode info */
  wednesday_stuff_M->Sizes.checksums[0] = (2617999391U);
  wednesday_stuff_M->Sizes.checksums[1] = (2691721586U);
  wednesday_stuff_M->Sizes.checksums[2] = (1415438919U);
  wednesday_stuff_M->Sizes.checksums[3] = (674998633U);
