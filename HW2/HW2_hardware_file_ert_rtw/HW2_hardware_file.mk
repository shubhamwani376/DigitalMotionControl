###########################################################################
## Makefile generated for component 'HW2_hardware_file'. 
## 
## Makefile     : HW2_hardware_file.mk
## Generated on : Wed Feb 22 11:23:54 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/HW2_hardware_file.out
...
PRODUCT_NAME              = HW2_hardware_file
MAKEFILE                  = HW2_hardware_file.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/HW2_hardware_file.out
...
DEFINES_STANDARD = -DMODEL=HW2_hardware_file -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/HW2_hardware_file_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/HW2_hardware_file_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/HW2_hardware_file_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/HW2_hardware_file_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/HW2_hardware_file_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/HW2_hardware_file_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


HW2_hardware_file.obj : $(START_DIR)/HW2_hardware_file_ert_rtw/HW2_hardware_file.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


HW2_hardware_file_data.obj : $(START_DIR)/HW2_hardware_file_ert_rtw/HW2_hardware_file_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_pwm.obj : $(START_DIR)/HW2_hardware_file_ert_rtw/MW_c28xx_pwm.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_qep.obj : $(START_DIR)/HW2_hardware_file_ert_rtw/MW_c28xx_qep.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/HW2_hardware_file_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtGetInf.obj : $(START_DIR)/HW2_hardware_file_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtGetNaN.obj : $(START_DIR)/HW2_hardware_file_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rt_nonfinite.obj : $(START_DIR)/HW2_hardware_file_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
