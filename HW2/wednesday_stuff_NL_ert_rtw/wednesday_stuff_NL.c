...
void wednesday_stuff_NL_step(void)
{
  ...
  /* TransportDelay: '<Root>/Transport Delay2' */
  {
    real_T **uBuffer = (real_T**)
      &wednesday_stuff_NL_DW.TransportDelay2_PWORK.TUbufferPtrs[0];
    ...
    rtb_TransportDelay2 = rt_TDelayInterpolate(
      ...
      0.0,
      *uBuffer,
      wednesday_stuff_NL_DW.TransportDelay2_IWORK.CircularBufSize,
      &wednesday_stuff_NL_DW.TransportDelay2_IWORK.Last,
      wednesday_stuff_NL_DW.TransportDelay2_IWORK.Tail,
      wednesday_stuff_NL_DW.TransportDelay2_IWORK.Head,
      wednesday_stuff_NL_P.TransportDelay2_InitOutput,
      1,
      0);
  }
  ...
  wednesday_stuff_NL_B.Sum1 = wednesday_stuff_NL_P.OutputvoltagetoPWM1_Gain *
    rtb_TransportDelay2 * wednesday_stuff_NL_P.OutputvoltagetoPWM_Gain +
  ...
  /* Update for TransportDelay: '<Root>/Transport Delay2' */
  {
    ...
    wednesday_stuff_NL_DW.TransportDelay2_IWORK.Head =
      ((wednesday_stuff_NL_DW.TransportDelay2_IWORK.Head <
        (wednesday_stuff_NL_DW.TransportDelay2_IWORK.CircularBufSize-1)) ?
       (wednesday_stuff_NL_DW.TransportDelay2_IWORK.Head+1) : 0);
    if (wednesday_stuff_NL_DW.TransportDelay2_IWORK.Head ==
        wednesday_stuff_NL_DW.TransportDelay2_IWORK.Tail) {
      wednesday_stuff_NL_DW.TransportDelay2_IWORK.Tail =
        ((wednesday_stuff_NL_DW.TransportDelay2_IWORK.Tail <
          (wednesday_stuff_NL_DW.TransportDelay2_IWORK.CircularBufSize-1)) ?
         (wednesday_stuff_NL_DW.TransportDelay2_IWORK.Tail+1) : 0);
    }

    (*uBuffer + wednesday_stuff_NL_DW.TransportDelay2_IWORK.CircularBufSize)
      [wednesday_stuff_NL_DW.TransportDelay2_IWORK.Head] = simTime;
    (*uBuffer)[wednesday_stuff_NL_DW.TransportDelay2_IWORK.Head] =
      wednesday_stuff_NL_B.u;
  }
...
void wednesday_stuff_NL_initialize(void)
{
  ...
  {
    real_T *pBuffer = &wednesday_stuff_NL_DW.TransportDelay2_RWORK.TUbufferArea
      [0];
    wednesday_stuff_NL_DW.TransportDelay2_IWORK.Tail = 0;
    wednesday_stuff_NL_DW.TransportDelay2_IWORK.Head = 0;
    wednesday_stuff_NL_DW.TransportDelay2_IWORK.Last = 0;
    wednesday_stuff_NL_DW.TransportDelay2_IWORK.CircularBufSize = 4096;
    pBuffer[0] = wednesday_stuff_NL_P.TransportDelay2_InitOutput;
    pBuffer[4096] = wednesday_stuff_NL_M->Timing.t[0];
    wednesday_stuff_NL_DW.TransportDelay2_PWORK.TUbufferPtrs[0] = (void *)
      &pBuffer[0];
  }
  ...
  wednesday_stuff_NL_DW.xint = 0.0;
}
